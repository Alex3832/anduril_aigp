...
class MAVLinkRX:
    ...
    def on_track_data(self, payload):
        ...
        payload = payload[2:]
        self.data['gates'] = [{} for _ in range(num_gates)]
        for i in range(num_gates):
            ...
            self.data['gates'][i] = {
                'gate_id': gate_id,
                'position_ned_x': position_ned_x,
                'position_ned_y': position_ned_y,
                'position_ned_z': position_ned_z,
                'orientation_ned_w': orientation_ned_w,
                'orientation_ned_x': orientation_ned_x,
                'orientation_ned_y': orientation_ned_y,
                'orientation_ned_z': orientation_ned_z,
                'width': width,
                'height': height
            }
